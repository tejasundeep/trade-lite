...
def calculate_key_levels() -> dict:
    ...
    fibs = {
        "fib_0": float(sh),
        "fib_0.382": float(sh - 0.382 * diff),
        "fib_0.5": float(sh - 0.5 * diff),
        "fib_0.618": float(sh - 0.618 * diff),
        "fib_0.705": float(sh - 0.705 * diff),
        "fib_0.786": float(sh - 0.786 * diff),
        "fib_1": float(sl),
    }
    ...
    return {
        "fibonacci_retracements": fibs,
        "daily_pivots": pivots,
        "ote_zone": {
            "lower": min(fibs["fib_0.705"], fibs["fib_0.786"]),
            "upper": max(fibs["fib_0.705"], fibs["fib_0.786"]),
        },
    }
